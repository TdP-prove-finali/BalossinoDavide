...
public class PunteggioGiocatore {
	...
	private Float pesoAssit;
	private Float pesoRimbalzi;
	public PunteggioGiocatore(String nome, Squadre squadra, Integer eta, Integer salary, String posizione,
			Integer games_played, Integer games_started, Float minutes_pergame, Float fg_made, Float fg_attemp,
			String fg_perc, Float p3_made, String p3_perce, Float p3_attemp, Float p2_made, String p2_perce,
			Float p2_attemp, Float orimb, Float drimb, Float trimb, Float assist, Float steal, Float turnovers,
			Float points, Float plus, Float vorp, Float blocks, String inj, Float pesoScorer, Float pesoAssit,
			Float pesoRimbalzi) {
		super();
		this.nome = nome;
	...
	public void setPesoAssit(Float pesoAssit) {
		this.pesoAssit = pesoAssit;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PunteggioGiocatore other = (PunteggioGiocatore) obj;
		if (eta == null) {
			if (other.eta != null)
				return false;
